...
var MapsLib = {
  ...
  fusionTableId:      "1WuvMqAcRy1fKdjAh-BcLvJUzqAobN-cscotEAhXU",
  ...
  map_centroid:       new google.maps.LatLng(38.885297, -76.923897), //MODIFY center that your map defaults to
  ...
  //-----custom filters-------
    ...
    var tempWhereClause = [];
    if ( $("#cbType1").is(':checked')) tempWhereClause.push("Illegal Dumping");
    if ( $("#cbType2").is(':checked')) tempWhereClause.push("Abandon Vehicle");
    if ( $("#cbType3").is(':checked')) tempWhereClause.push("Pot Hole");
    if ( $("#cbType4").is(':checked')) tempWhereClause.push("General Environment");
    if ( $("#cbType5").is(':checked')) tempWhereClause.push("Street Repair");
